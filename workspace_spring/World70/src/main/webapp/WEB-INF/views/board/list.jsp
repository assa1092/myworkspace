		...
		<div class="row text-center">
			<nav aria-label="Page navigation">
				<ul class="pagination">
					...
					<li ><a href="/board/list?curPage=${to.curPage > 1? to.curPage-1 : 1 }" aria-label="Previous"> <span
					...
					<li><a href="#">5</a></li>
					--%>
					<li><a href="/board/list?curPage=${to.curPage < to.totalPage ? to.curPage+1 : to.curPage }" aria-label="Next"> <span
